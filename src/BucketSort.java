...
public class BucketSort {
    ...
    public static int bucketSort(int[] array) {
        ...
        int[] newbucket = new int[maximum_value + 1];// Создаем новое ведро с максимальным значением
        int[] sorted_array = new int[array.length];  // Создаем массив для отсортированных данных
        int iterations = 0;

        for (int a = 0; a < array.length; a++) { // прохождение по входному массиву для добавления каждого элемента в массив
            newbucket[array[a]]++;
        }

        // сортировка каждого элемента в массиве и добавление каждого отсортированного элемента по порядку в исходный входной массив
